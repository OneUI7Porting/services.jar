...
.method public constructor <init>(Lcom/android/server/wm/ActivityTaskManagerService;ILandroid/content/Intent;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;Landroid/content/ComponentName;Landroid/content/ComponentName;ZZIILjava/lang/String;JZLandroid/app/ActivityManager$TaskDescription;Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;IIIILjava/lang/String;Ljava/lang/String;IZZZIILandroid/content/pm/ActivityInfo;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;ZLandroid/os/IBinder;ZZ)V
    ...
    .line 50
    iput-boolean v5, v0, Lcom/android/server/wm/Task;->mTakeInitBounds:Z
    ...
    .line 53
    iput-object v4, v0, Lcom/android/server/wm/Task;->mMetaKeyBounds:Landroid/graphics/Rect;

    .line 54
    iput v5, v0, Lcom/android/server/wm/Task;->mDexCompatUiMode:I
    ...
    iput-object v8, v0, Lcom/android/server/wm/Task;->mSnappingGuideBounds:Landroid/graphics/Rect;
    ...
    .line 57
    iput v8, v0, Lcom/android/server/wm/Task;->mUserId:I
    ...
    invoke-direct {v8}, Landroid/app/ActivityManager$TaskDescription;-><init>()V
    ...
    .line 60
    :cond_1
    new-instance v8, Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;

    invoke-direct {v8}, Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;-><init>()V

    :goto_1
    iput-object v8, v0, Lcom/android/server/wm/Task;->mLastTaskSnapshotData:Landroid/app/ActivityManager$RecentTaskInfo$PersistedTaskSnapshotData;
    ...
    :goto_2
    iput-boolean v8, v0, Lcom/android/server/wm/Task;->mIsDexCompatEnabled:Z

    move-object v8, p4

    .line 62
    iput-object v8, v0, Lcom/android/server/wm/Task;->affinityIntent:Landroid/content/Intent;

    move-object v8, p5

    .line 63
    iput-object v8, v0, Lcom/android/server/wm/Task;->affinity:Ljava/lang/String;

    move-object/from16 v8, p6

    .line 64
    iput-object v8, v0, Lcom/android/server/wm/Task;->rootAffinity:Ljava/lang/String;

    move-object/from16 v8, p32

    .line 65
    iput-object v8, v0, Lcom/android/server/wm/Task;->voiceSession:Landroid/service/voice/IVoiceInteractionSession;

    move-object/from16 v8, p33

    .line 66
    iput-object v8, v0, Lcom/android/server/wm/Task;->voiceInteractor:Lcom/android/internal/app/IVoiceInteractor;

    move-object/from16 v8, p7

    .line 67
    iput-object v8, v0, Lcom/android/server/wm/Task;->realActivity:Landroid/content/ComponentName;
    ...
    .line 69
    iput-object v8, v0, Lcom/android/server/wm/Task;->origActivity:Landroid/content/ComponentName;

    move/from16 v8, p9

    .line 70
    iput-boolean v8, v0, Lcom/android/server/wm/Task;->rootWasReset:Z
    ...
    .line 79
    iput v7, v0, Lcom/android/server/wm/Task;->mAffiliatedTaskId:I
    ...
    .line 85
    iput v7, v0, Lcom/android/server/wm/Task;->mResizeMode:I
    ...
    .line 88
    iget v6, v2, Landroid/content/pm/ActivityInfo$WindowLayout;->minWidth:I
    ...
    invoke-virtual {v2, v3, p0}, Lcom/android/server/wm/MultiWindowSupportPolicyController;->updateSupportPolicyLocked(Landroid/content/pm/ActivityInfo;Lcom/android/server/wm/Task;)V
    ...
    .line 101
    invoke-virtual {v2, v3, p0, v4, v5}, Lcom/android/server/wm/MultiTaskingAppCompatController;->onOverridesChanged(ILcom/android/server/wm/Task;Ljava/lang/String;Z)V
...
.method public static enableEnterPipOnTaskSwitch(Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;)V
    .locals 2
    ...
    .line 5
    .line 6
    invoke-virtual {p0}, Landroid/app/ActivityOptions;->disallowEnterPictureInPictureWhileLaunching()Z
    ...
    .line 115
    .line 116
    invoke-virtual {p0}, Landroid/app/ActivityOptions;->getTransientLaunch()Z
    ...
    .line 123
    .line 124
    invoke-virtual {p0, p3}, Lcom/android/server/wm/TransitionController;->isTransientHide(Lcom/android/server/wm/Task;)Z
    ...
    .line 133
    :goto_1
    invoke-virtual {p3}, Lcom/android/server/wm/ConfigurationContainer;->isActivityTypeAssistant()Z
...
.method public final addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    .line 3
    sget-object p2, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_ADD_REMOVE_enabled:[Z
...
.method public final applyAnimationUnchecked(Landroid/view/WindowManager$LayoutParams;ZIZLjava/util/ArrayList;)V
    ...
    .line 14
    .line 15
    sget-object p1, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_RECENTS_ANIMATIONS_enabled:[Z
...
.method public final assignChildLayers(Landroid/view/SurfaceControl$Transaction;)V
    ...
    .line 125
    .line 126
    iget-object v7, v7, Lcom/android/server/wm/TaskFragment;->mAdjacentTaskFragment:Lcom/android/server/wm/TaskFragment;
    ...
    .line 135
    .line 136
    invoke-virtual {v7}, Lcom/android/server/wm/TaskFragment;->isDimmingOnParentTask()Z
    ...
    .line 153
    iget-object v9, v9, Lcom/android/server/wm/WindowContainer;->mChildren:Lcom/android/server/wm/WindowList;
    ...
    .line 172
    :cond_6
    new-instance v9, Lcom/android/server/wm/TaskFragment$$ExternalSyntheticLambda12;
    ...
    .line 176
    .line 177
    invoke-virtual {v8, v9, v6}, Lcom/android/server/wm/WindowContainer;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
    ...
    .line 184
    :cond_7
    invoke-virtual {v7, v9, v6}, Lcom/android/server/wm/WindowContainer;->forAllWindows(Lcom/android/internal/util/ToBooleanFunction;Z)Z
    ...
    .line 191
    .line 192
    invoke-virtual {v7, p1, v5}, Lcom/android/server/wm/WindowContainer;->assignLayer(Landroid/view/SurfaceControl$Transaction;I)V
...
.method public final clearTopActivities(Lcom/android/server/wm/ActivityRecord;I[I)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 40
    .line 41
    invoke-direct {p1, p3}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda31;-><init>([I)V
...
.method public final dump(Ljava/io/PrintWriter;Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "mMetaKeyBounds="
...
.method public final dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    const-string/jumbo p2, "mFinishedTokens="
...
.method public final dumpInner(Ljava/io/PrintWriter;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    .line 126
    .line 127
    invoke-static {v2}, Lcom/samsung/android/core/SizeCompatInfo;->sizeCompatModeToString(I)Ljava/lang/String;
    ...
    .line 169
    .line 170
    iget v5, v1, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->mHeight:I
    ...
    .line 208
    invoke-virtual {v1}, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->getTopOrientationInTask()I
    ...
    .line 223
    :cond_7
    iget v4, v1, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->mUserScale:F
    ...
    .line 236
    .line 237
    const-string v4, ", UserOrientation="
    ...
    .line 241
    .line 242
    iget v1, v1, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->mUserOrientation:I

    .line 243
    .line 244
    invoke-static {v1}, Lcom/samsung/android/core/CompatUtils;->orientationToString(I)Ljava/lang/String;
    ...
    .line 342
    sget-object v3, Lcom/android/server/wm/PackagesChange;->sAllPackagesChangeAsTask:Ljava/util/List;
    ...
    .line 360
    check-cast v4, Lcom/android/server/wm/DisplayCutoutController;
    ...
    .line 364
    .line 365
    iget v4, p0, Lcom/android/server/wm/Task;->mCutoutPolicy:I
    ...
    .line 392
    :cond_d
    const-string v4, "HideCameraCutout"
    ...
    .line 395
    :cond_e
    const-string v4, "OverlapWithTheCameraCutout"
    ...
    .line 415
    :try_start_0
    iget-object v3, v1, Lcom/android/server/wm/MultiTaskingAppCompatController;->mOverridesObservers:Ljava/util/List;
    ...
    .line 424
    :cond_11
    new-instance v4, Lcom/android/server/wm/MultiTaskingAppCompatController$$ExternalSyntheticLambda5;

    .line 425
    .line 426
    invoke-direct {v4, p0, p1, v2}, Lcom/android/server/wm/MultiTaskingAppCompatController$$ExternalSyntheticLambda5;-><init>(Lcom/android/server/wm/Task;Ljava/io/PrintWriter;Ljava/lang/String;)V
...
.method public final fillTaskInfo(Landroid/app/TaskInfo;ZLcom/android/server/wm/TaskDisplayArea;)V
    ...
    :goto_3
    iput-object v7, v1, Landroid/app/TaskInfo;->baseIntent:Landroid/content/Intent;
    ...
    .line 21
    :goto_4
    iput-boolean v8, v1, Landroid/app/TaskInfo;->isRunning:Z

    if-eqz v6, :cond_6

    .line 22
    iget-object v8, v6, Lcom/android/server/wm/ActivityRecord;->mActivityComponent:Landroid/content/ComponentName;
    ...
    :goto_5
    iput-object v8, v1, Landroid/app/TaskInfo;->topActivity:Landroid/content/ComponentName;

    .line 23
    iget-object v8, v0, Lcom/android/server/wm/Task;->origActivity:Landroid/content/ComponentName;

    iput-object v8, v1, Landroid/app/TaskInfo;->origActivity:Landroid/content/ComponentName;

    .line 24
    iget-object v8, v0, Lcom/android/server/wm/Task;->realActivity:Landroid/content/ComponentName;

    iput-object v8, v1, Landroid/app/TaskInfo;->realActivity:Landroid/content/ComponentName;

    .line 25
    iget-wide v8, v0, Lcom/android/server/wm/Task;->lastActiveTime:J

    iput-wide v8, v1, Landroid/app/TaskInfo;->lastActiveTime:J

    .line 26
    new-instance v8, Landroid/app/ActivityManager$TaskDescription;

    .line 27
    iget-object v9, v0, Lcom/android/server/wm/Task;->mTaskDescription:Landroid/app/ActivityManager$TaskDescription;

    .line 28
    invoke-direct {v8, v9}, Landroid/app/ActivityManager$TaskDescription;-><init>(Landroid/app/ActivityManager$TaskDescription;)V

    iput-object v8, v1, Landroid/app/TaskInfo;->taskDescription:Landroid/app/ActivityManager$TaskDescription;
    ...
    .line 30
    iput-boolean v8, v1, Landroid/app/TaskInfo;->supportsMultiWindow:Z

    .line 31
    invoke-virtual {v0, v2, v7}, Lcom/android/server/wm/TaskFragment;->supportsMultiWindowInDisplayArea(Lcom/android/server/wm/TaskDisplayArea;Z)Z
    ...
    invoke-virtual {v2, v8}, Landroid/content/res/Configuration;->setTo(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v2, v8}, Landroid/app/WindowConfiguration;->setActivityType(I)V
    ...
    invoke-virtual {v2, v8}, Landroid/app/WindowConfiguration;->setWindowingMode(I)V
    ...
    .line 38
    :goto_7
    iget v8, v2, Lcom/android/server/wm/Task;->mResizeMode:I

    iput v8, v1, Landroid/app/TaskInfo;->resizeMode:I
    ...
    iput v8, v1, Landroid/app/TaskInfo;->topActivityType:I
    ...
    .line 41
    invoke-virtual {v0, v7}, Lcom/android/server/wm/Task;->isResizeable(Z)Z
    ...
    iget-object v8, v6, Lcom/android/server/wm/ActivityRecord;->pictureInPictureArgs:Landroid/app/PictureInPictureParams;

    invoke-direct {v2, v8}, Landroid/app/PictureInPictureParams;-><init>(Landroid/app/PictureInPictureParams;)V
    ...
    .line 63
    iget-boolean v8, v2, Lcom/android/server/wm/TaskFragment;->mCreatedByOrganizer:Z
    ...
    invoke-direct {v2, v8}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda0;-><init>(I)V
    ...
    .line 75
    invoke-virtual {v6, v7}, Lcom/android/server/wm/ActivityRecord;->occludesParent(Z)Z
    ...
    invoke-virtual {v8}, Lcom/android/server/wm/Task;->getOrganizedTask()Lcom/android/server/wm/Task;
    ...
    invoke-virtual {v6, v8}, Lcom/android/server/wm/ActivityRecord;->isState(Lcom/android/server/wm/ActivityRecord$State;)Z
    ...
    .line 92
    iget-boolean v9, v6, Lcom/android/server/wm/ActivityRecord;->mVisible:Z
    ...
    .line 94
    :goto_1a
    invoke-virtual {v2, v9}, Landroid/app/AppCompatTaskInfo;->setTopActivityInSizeCompat(Z)V
    ...
    iget-object v9, v6, Lcom/android/server/wm/WindowContainer;->mWmService:Lcom/android/server/wm/WindowManagerService;

    iget-object v9, v9, Lcom/android/server/wm/WindowManagerService;->mAppCompatConfiguration:Lcom/android/server/wm/AppCompatConfiguration;

    .line 96
    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatConfiguration;->isTranslucentLetterboxingEnabled()Z
    ...
    .line 100
    :goto_1b
    invoke-virtual {v2, v9}, Landroid/app/AppCompatTaskInfo;->setEligibleForLetterboxEducation(Z)V
    ...
    .line 103
    iget-object v9, v9, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatLetterboxOverrides:Lcom/android/server/wm/AppCompatLetterboxOverrides;

    .line 104
    iget-object v9, v9, Lcom/android/server/wm/AppCompatLetterboxOverrides;->mAppCompatConfiguration:Lcom/android/server/wm/AppCompatConfiguration;

    .line 105
    iget-boolean v9, v9, Lcom/android/server/wm/AppCompatConfiguration;->mIsEducationEnabled:Z

    .line 106
    invoke-virtual {v2, v9}, Landroid/app/AppCompatTaskInfo;->setLetterboxEducationEnabled(Z)V
    ...
    .line 109
    iget-object v9, v9, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatAspectRatioOverrides:Lcom/android/server/wm/AppCompatAspectRatioOverrides;

    .line 110
    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->shouldApplyUserFullscreenOverride()Z

    move-result v10

    .line 111
    invoke-virtual {v2, v10}, Landroid/app/AppCompatTaskInfo;->setUserFullscreenOverrideEnabled(Z)V

    .line 112
    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->isSystemOverrideToFullscreenEnabled()Z

    move-result v10

    .line 113
    invoke-virtual {v2, v10}, Landroid/app/AppCompatTaskInfo;->setSystemFullscreenOverrideEnabled(Z)V

    .line 114
    iget-object v10, v3, Lcom/android/server/wm/AppCompatReachabilityOverrides;->mReachabilityState:Lcom/android/server/wm/AppCompatReachabilityOverrides$ReachabilityState;

    .line 115
    iget-boolean v11, v10, Lcom/android/server/wm/AppCompatReachabilityOverrides$ReachabilityState;->mIsDoubleTapEvent:Z

    .line 116
    iput-boolean v4, v10, Lcom/android/server/wm/AppCompatReachabilityOverrides$ReachabilityState;->mIsDoubleTapEvent:Z

    .line 117
    invoke-virtual {v2, v11}, Landroid/app/AppCompatTaskInfo;->setIsFromLetterboxDoubleTap(Z)V
    ...
    iput v12, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxWidth:I
    ...
    iput v10, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxHeight:I
    ...
    iput v10, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxAppWidth:I
    ...
    iput v10, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxAppHeight:I

    .line 124
    iget-object v10, v3, Lcom/android/server/wm/AppCompatReachabilityOverrides;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;
    ...
    invoke-virtual {v3, v11}, Lcom/android/server/wm/AppCompatReachabilityOverrides;->isHorizontalReachabilityEnabled(Landroid/content/res/Configuration;)Z
    ...
    invoke-virtual {v3, v10}, Lcom/android/server/wm/AppCompatReachabilityOverrides;->isVerticalReachabilityEnabled(Landroid/content/res/Configuration;)Z
    ...
    .line 126
    :goto_1d
    invoke-virtual {v2, v10}, Landroid/app/AppCompatTaskInfo;->setLetterboxDoubleTapEnabled(Z)V
    ...
    iget-object v11, v3, Lcom/android/server/wm/AppCompatReachabilityOverrides;->mAppCompatDeviceStateQuery:Lcom/android/server/wm/AppCompatDeviceStateQuery;

    iget-object v12, v3, Lcom/android/server/wm/AppCompatReachabilityOverrides;->mAppCompatConfiguration:Lcom/android/server/wm/AppCompatConfiguration;
    ...
    .line 131
    invoke-virtual {v11, v4}, Lcom/android/server/wm/AppCompatDeviceStateQuery;->isDisplayFullScreenAndInPosture(Z)Z
    ...
    .line 132
    iget-boolean v10, v12, Lcom/android/server/wm/AppCompatConfiguration;->mIsAutomaticReachabilityInBookModeEnabled:Z
    ...
    .line 133
    :goto_1f
    iget-object v11, v12, Lcom/android/server/wm/AppCompatConfiguration;->mAppCompatConfigurationPersister:Lcom/android/server/wm/AppCompatConfigurationPersister;

    .line 134
    invoke-virtual {v11, v10}, Lcom/android/server/wm/AppCompatConfigurationPersister;->getLetterboxPositionForHorizontalReachability(Z)I

    move-result v10

    .line 135
    iput v10, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxHorizontalPosition:I
    ...
    .line 139
    invoke-virtual {v11}, Lcom/android/server/wm/AppCompatDeviceStateQuery;->isDisplayFullScreenAndSeparatingHinge()Z
    ...
    .line 141
    invoke-virtual {v11, v10}, Lcom/android/server/wm/AppCompatConfigurationPersister;->getLetterboxPositionForVerticalReachability(Z)I

    move-result v10

    .line 142
    iput v10, v2, Landroid/app/AppCompatTaskInfo;->topActivityLetterboxVerticalPosition:I
    ...
    :cond_28
    :goto_21
    iget-boolean v10, v1, Landroid/app/TaskInfo;->isTopActivityTransparent:Z
    ...
    .line 146
    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->shouldEnableUserAspectRatioSettings()Z
    ...
    .line 147
    :goto_22
    invoke-virtual {v2, v9}, Landroid/app/AppCompatTaskInfo;->setEligibleForUserAspectRatioButton(Z)V
    ...
    invoke-virtual {v2, v9}, Landroid/app/AppCompatTaskInfo;->setTopActivityLetterboxed(Z)V

    .line 149
    iget-object v9, v2, Landroid/app/AppCompatTaskInfo;->cameraCompatTaskInfo:Landroid/app/CameraCompatTaskInfo;

    iget-object v10, v6, Lcom/android/server/wm/ActivityRecord;->mAppCompatController:Lcom/android/server/wm/AppCompatController;

    .line 150
    iget-object v11, v10, Lcom/android/server/wm/AppCompatController;->mAppCompatOverrides:Lcom/android/server/wm/AppCompatOverrides;

    .line 151
    iget-object v11, v11, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatCameraOverrides:Lcom/android/server/wm/AppCompatCameraOverrides;

    .line 152
    iget-object v11, v11, Lcom/android/server/wm/AppCompatCameraOverrides;->mAppCompatCameraOverridesState:Lcom/android/server/wm/AppCompatCameraOverrides$AppCompatCameraOverridesState;

    .line 153
    iget v11, v11, Lcom/android/server/wm/AppCompatCameraOverrides$AppCompatCameraOverridesState;->mFreeformCameraCompatMode:I

    .line 154
    iput v11, v9, Landroid/app/CameraCompatTaskInfo;->freeformCameraCompatMode:I

    .line 155
    iget-object v9, v10, Lcom/android/server/wm/AppCompatController;->mDesktopAppCompatAspectRatioPolicy:Lcom/android/server/wm/DesktopAppCompatAspectRatioPolicy;

    iget-object v10, v9, Lcom/android/server/wm/DesktopAppCompatAspectRatioPolicy;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;

    .line 156
    iget-object v11, v10, Lcom/android/server/wm/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    invoke-virtual {v11}, Landroid/content/pm/ActivityInfo;->getMinAspectRatio()F

    move-result v11

    .line 157
    iget-object v12, v9, Lcom/android/server/wm/DesktopAppCompatAspectRatioPolicy;->mTransparentPolicy:Lcom/android/server/wm/TransparentPolicy;

    iget-object v13, v12, Lcom/android/server/wm/TransparentPolicy;->mTransparentPolicyState:Lcom/android/server/wm/TransparentPolicy$TransparentPolicyState;

    .line 158
    invoke-virtual {v13}, Lcom/android/server/wm/TransparentPolicy$TransparentPolicyState;->isRunning()Z
    ...
    .line 159
    iget-object v9, v12, Lcom/android/server/wm/TransparentPolicy;->mTransparentPolicyState:Lcom/android/server/wm/TransparentPolicy$TransparentPolicyState;

    .line 160
    iget v9, v9, Lcom/android/server/wm/TransparentPolicy$TransparentPolicyState;->mInheritedMinAspectRatio:F
    ...
    .line 164
    :cond_2b
    iget-object v13, v9, Lcom/android/server/wm/DesktopAppCompatAspectRatioPolicy;->mAppCompatOverrides:Lcom/android/server/wm/AppCompatOverrides;

    iget-object v14, v13, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatAspectRatioOverrides:Lcom/android/server/wm/AppCompatAspectRatioOverrides;

    .line 165
    iget-object v15, v14, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->mAllowUserAspectRatioOverrideOptProp:Lcom/android/server/wm/utils/OptPropFactory$OptProp;

    .line 166
    invoke-virtual {v15}, Lcom/android/server/wm/utils/OptPropFactory$OptProp;->isFalse()Z
    ...
    .line 167
    iget-object v9, v9, Lcom/android/server/wm/DesktopAppCompatAspectRatioPolicy;->mAppCompatConfiguration:Lcom/android/server/wm/AppCompatConfiguration;

    .line 168
    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatConfiguration;->isUserAppAspectRatioSettingsEnabled()Z
    ...
    .line 169
    invoke-virtual {v9}, Lcom/android/server/wm/DisplayArea;->getIgnoreOrientationRequest()Z
    ...
    .line 170
    iget-object v9, v13, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatAspectRatioOverrides:Lcom/android/server/wm/AppCompatAspectRatioOverrides;

    invoke-virtual {v9}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->getUserMinAspectRatioOverrideCode()I
    ...
    .line 171
    invoke-virtual {v14}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->getUserMinAspectRatio()F
    ...
    .line 172
    :cond_2c
    iget-object v9, v14, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->mActivityRecord:Lcom/android/server/wm/ActivityRecord;

    iget-object v9, v9, Lcom/android/server/wm/ActivityRecord;->info:Landroid/content/pm/ActivityInfo;

    const-wide/32 v4, 0xa5faf64

    invoke-virtual {v9, v4, v5}, Landroid/content/pm/ActivityInfo;->isChangeEnabled(J)Z

    move-result v4

    .line 173
    iget-object v5, v14, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->mAllowMinAspectRatioOverrideOptProp:Lcom/android/server/wm/utils/OptPropFactory$OptProp;

    invoke-virtual {v5, v4}, Lcom/android/server/wm/utils/OptPropFactory$OptProp;->shouldEnableWithOptInOverrideAndOptOutProperty(Z)Z
    ...
    .line 174
    iget-object v4, v13, Lcom/android/server/wm/AppCompatOverrides;->mAppCompatCameraOverrides:Lcom/android/server/wm/AppCompatCameraOverrides;

    invoke-virtual {v4}, Lcom/android/server/wm/AppCompatCameraOverrides;->shouldOverrideMinAspectRatioForCamera()Z
    ...
    .line 176
    invoke-virtual {v12, v4, v5}, Landroid/content/pm/ActivityInfo;->isChangeEnabled(J)Z
    ...
    .line 177
    invoke-virtual {v10}, Lcom/android/server/wm/ActivityRecord;->getOverrideOrientation()I
    ...
    .line 185
    invoke-virtual {v14}, Lcom/android/server/wm/AppCompatAspectRatioOverrides;->getSplitScreenAspectRatio()F
    ...
    .line 198
    :goto_24
    invoke-virtual {v2, v4}, Landroid/app/AppCompatTaskInfo;->setHasMinAspectRatioOverride(Z)V
    ...
    iget-object v4, v6, Lcom/android/server/wm/ActivityRecord;->mAppCompatController:Lcom/android/server/wm/AppCompatController;
    ...
    .line 201
    invoke-virtual {v4}, Lcom/android/server/wm/AppCompatAspectRatioPolicy;->isUserOrSystemMinAspectRatioApplied()Z
    ...
    .line 202
    invoke-virtual {v2, v7}, Landroid/app/AppCompatTaskInfo;->setHasMinAspectRatioOverride(Z)V
    ...
    .line 207
    invoke-virtual {v2, v7}, Landroid/app/AppCompatTaskInfo;->setRotationCompatModeEnabled(Z)V
    ...
    :goto_25
    iput-object v4, v2, Landroid/app/AppCompatTaskInfo;->topActivityBounds:Landroid/graphics/Rect;

    .line 212
    sget-boolean v4, Lcom/samsung/android/rune/CoreRune;->MT_APP_COMPAT_CONFIGURATION:Z
    ...
    .line 218
    invoke-virtual {v0, v2}, Lcom/android/server/wm/Task;->getTopVisibleAppMainWindow(Z)Lcom/android/server/wm/WindowState;
    ...
    .line 226
    :goto_28
    sget-boolean v3, Lcom/samsung/android/rune/CoreRune;->MT_SIZE_COMPAT_POLICY:Z

    if-eqz v3, :cond_40

    .line 227
    sget-object v3, Lcom/android/server/wm/SizeCompatPolicyManager$LazyHolder;->sManager:Lcom/android/server/wm/SizeCompatPolicyManager;

    .line 228
    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    .line 229
    invoke-static {v0, v2}, Lcom/android/server/wm/SizeCompatPolicyManager;->getCompatPolicy(Lcom/android/server/wm/Task;Z)Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;
    ...
    .line 230
    iput-boolean v2, v1, Landroid/app/TaskInfo;->topActivityInSizeCompat:Z

    .line 231
    iget-object v4, v1, Landroid/app/TaskInfo;->sizeCompatInfo:Lcom/samsung/android/core/SizeCompatInfo;

    if-nez v4, :cond_3d

    .line 232
    new-instance v4, Lcom/samsung/android/core/SizeCompatInfo;

    invoke-direct {v4}, Lcom/samsung/android/core/SizeCompatInfo;-><init>()V

    .line 233
    iput-object v4, v1, Landroid/app/TaskInfo;->sizeCompatInfo:Lcom/samsung/android/core/SizeCompatInfo;

    goto :goto_29

    .line 234
    :cond_3d
    invoke-virtual {v4}, Lcom/samsung/android/core/SizeCompatInfo;->clear()V
    ...
    .line 236
    invoke-virtual {v4, v7}, Lcom/samsung/android/core/SizeCompatInfo;->setMode(I)V
    ...
    .line 238
    iget-object v2, v3, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->mTask:Lcom/android/server/wm/Task;
    ...
    .line 239
    sget-boolean v2, Lcom/samsung/android/rune/CoreRune;->MT_DEX_SIZE_COMPAT_DRAG:Z
    ...
    .line 240
    invoke-virtual {v3, v4}, Lcom/android/server/wm/DexSizeCompatController$DexSizeCompatPolicy;->fillSizeCompatInfoForDrag(Lcom/samsung/android/core/SizeCompatInfo;)V
    ...
    iget v4, v3, Landroid/content/res/Configuration;->dexCompatEnabled:I
    ...
    .line 254
    invoke-virtual {v0, v7, v3}, Lcom/android/server/wm/Task;->getTopVisibleActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    :goto_31
    iput-boolean v2, v1, Landroid/app/TaskInfo;->isTopTransparentActivity:Z
    ...
    .line 261
    iget-object v2, v6, Lcom/android/server/wm/ActivityRecord;->mPopOverState:Lcom/android/server/wm/PopOverState;
    ...
    .line 263
    :goto_33
    iput-boolean v4, v1, Landroid/app/TaskInfo;->hasPopOver:Z

    .line 264
    iget-boolean v0, v0, Lcom/android/server/wm/Task;->mIsAliasManaged:Z

    iput-boolean v0, v1, Landroid/app/TaskInfo;->isAliasManaged:Z
...
.method public final getLaunchBounds()Landroid/graphics/Rect;
    ...
    .line 56
    .line 57
    iget-object v5, v1, Lcom/android/server/wm/ActivityTaskSupervisor;->mLaunchParamsController:Lcom/android/server/wm/LaunchParamsController;

    .line 58
    .line 59
    invoke-virtual {p0, v4, v4}, Lcom/android/server/wm/TaskFragment;->getTopNonFinishingActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 71
    invoke-virtual/range {v5 .. v14}, Lcom/android/server/wm/LaunchParamsController;->calculate(Lcom/android/server/wm/Task;Landroid/content/pm/ActivityInfo$WindowLayout;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityStarter$Request;ILcom/android/server/wm/LaunchParamsController$LaunchParams;Lcom/android/server/wm/TaskDisplayArea;)V
...
.method public final isDexCompatEnabled()Z
    .locals 1
...
.method public final isDexTaskDocked()Z
    .locals 1
...
.method public final moveTaskToBackInner(Lcom/android/server/wm/Task;Lcom/android/server/wm/Transition;Landroid/os/Bundle;ZII)V
    ...
    .line 106
    .line 107
    iget-object p4, p4, Lcom/android/server/wm/ActivityTaskManagerService;->mDexDockingController:Lcom/android/server/wm/DexDockingController;

    .line 108
    .line 109
    const-string/jumbo p5, "moveTaskToBack"

    .line 110
    .line 111
    .line 112
    invoke-virtual {p4, p5}, Lcom/android/server/wm/DexDockingController;->clearAllTasks(Ljava/lang/String;)V
...
.method public final moveTaskToFront(Lcom/android/server/wm/Task;ZLandroid/app/ActivityOptions;Lcom/android/server/am/AppTimeTracker;ZLjava/lang/String;)V
    ...
    .line 260
    .line 261
    invoke-static {p3, v0, p4, p1}, Lcom/android/server/wm/Task;->enableEnterPipOnTaskSwitch(Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;)V
...
.method public moveToFront(Ljava/lang/String;Lcom/android/server/wm/Task;)V
    ...
    .line 284
    .line 285
    const-string/jumbo v4, "moveTaskToFrontIfNeeded="
    ...
    .line 302
    .line 303
    iget-object v3, v2, Lcom/android/server/wm/DexDockingController;->mSkipMoveToFrontList:Ljava/util/ArrayList;
    ...
    .line 326
    :goto_3
    iget-object v4, v2, Lcom/android/server/wm/DexDockingController;->mAtm:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    .line 329
    .line 330
    new-instance v5, Lcom/android/server/wm/DexDockingController$$ExternalSyntheticLambda3;

    .line 331
    .line 332
    invoke-direct {v5, v2, v3}, Lcom/android/server/wm/DexDockingController$$ExternalSyntheticLambda3;-><init>(Lcom/android/server/wm/DexDockingController;I)V
    ...
    .line 337
    .line 338
    iget-object v2, v2, Lcom/android/server/wm/DexDockingController;->mSkipMoveToFrontList:Ljava/util/ArrayList;
...
.method public final navigateUpTo(Lcom/android/server/wm/ActivityRecord;Landroid/content/Intent;Ljava/lang/String;Lcom/android/server/uri/NeededUriGrants;ILandroid/content/Intent;Lcom/android/server/uri/NeededUriGrants;)Z
    ...
    .line 107
    new-instance v13, Lcom/android/server/wm/Task$$ExternalSyntheticLambda41;

    .line 108
    .line 109
    invoke-direct {v13, v4, v6, v11, v12}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda41;-><init>(Lcom/android/server/wm/ActivityRecord;[I[Landroid/content/Intent;[Lcom/android/server/uri/NeededUriGrants;)V
...
.method public final onConfigurationChangedInner(Landroid/content/res/Configuration;)V
    ...
    .line 205
    .line 206
    invoke-direct {v2, v9, v8}, Lcom/android/server/wm/MultiTaskingAppCompatSizeCompatModePolicy$$ExternalSyntheticLambda0;-><init>(ZZ)V
    ...
    .line 582
    const-string/jumbo v2, "maximize_force_hidden_freeform"

    .line 583
    .line 584
    .line 585
    invoke-virtual {v0, v1, v2, v9}, Lcom/android/server/wm/ChangeTransitionController;->requestDisplayChangeTransition(ILjava/lang/String;Z)V
    ...
    .line 791
    invoke-virtual {v0, v1, v2}, Lcom/android/server/wm/DexDockingController;->isValidDockingBounds(ILandroid/graphics/Rect;)Z
    ...
    .line 827
    const-string v2, "DexDockingController"
    ...
    .line 835
    .line 836
    new-instance v1, Lcom/android/server/wm/DexDockingController$$ExternalSyntheticLambda2;

    .line 837
    .line 838
    invoke-direct {v1, p0}, Lcom/android/server/wm/DexDockingController$$ExternalSyntheticLambda2;-><init>(Lcom/android/server/wm/Task;)V
...
.method public final onParentChanged(Lcom/android/server/wm/ConfigurationContainer;Lcom/android/server/wm/ConfigurationContainer;)V
    ...
    .line 392
    .line 393
    invoke-direct {v1, v3, v4}, Lcom/android/server/wm/MultiTaskingAppCompatSizeCompatModePolicy$$ExternalSyntheticLambda0;-><init>(ZZ)V
    ...
    .line 420
    .line 421
    invoke-virtual {v1, v5, p0, v2, v4}, Lcom/android/server/wm/MultiTaskingAppCompatController;->onOverridesChanged(ILcom/android/server/wm/Task;Ljava/lang/String;Z)V
    ...
    .line 426
    .line 427
    invoke-virtual {p0, v4}, Lcom/android/server/wm/Task;->updateTaskOrganizerState(Z)Z
    ...
    .line 592
    .line 593
    iget-object p2, p1, Lcom/android/server/wm/DexController;->mMinimizedToggleTasks:Ljava/util/List;
    ...
    .line 602
    .line 603
    iget-object p1, p1, Lcom/android/server/wm/DexController;->mMinimizedToggleTasks:Ljava/util/List;
    ...
    .line 615
    .line 616
    invoke-virtual {p0, v0, v0, v4}, Lcom/android/server/wm/Task;->updateDexCompatMode(Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;Z)V
    ...
    .line 623
    .line 624
    iput v4, p0, Lcom/android/server/wm/Task;->mDexLaunchPolicy:I

    .line 625
    .line 626
    iput-boolean v4, p0, Lcom/android/server/wm/Task;->mIsDexCompatEnabled:Z

    .line 627
    .line 628
    iput v4, p0, Lcom/android/server/wm/Task;->mDexCompatUiMode:I
...
.method public final pauseActivityIfNeeded(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)Z
    ...
    .line 58
    .line 59
    invoke-direct {v3, p0, p1, p2, v2}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda34;-><init>(Lcom/android/server/wm/Task;Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;[I)V
...
.method public final removeActivities(Ljava/lang/String;Z)V
    ...
    .line 21
    .line 22
    invoke-direct {v0, p0, p2, p1}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda36;-><init>(Lcom/android/server/wm/Task;ZLjava/lang/String;)V
...
.method public final removeChild(Lcom/android/server/wm/WindowContainer;Ljava/lang/String;)V
    ...
    .line 6
    invoke-virtual {p0, p1, v3}, Lcom/android/server/wm/TaskFragment;->removeChild(Lcom/android/server/wm/WindowContainer;Z)V
    ...
    .line 29
    const-string/jumbo p2, "taskRemoved"

    iget-object v0, p1, Lcom/android/server/wm/DexController;->mPendingActivityInfo:Lcom/android/server/wm/DexController$PendingActivityInfo;

    invoke-virtual {v0, p2, p0}, Lcom/android/server/wm/DexController$PendingActivityInfo;->removeWaitingStoppedTask(Ljava/lang/String;Lcom/android/server/wm/Task;)Z
    ...
    .line 30
    iget-object p0, v0, Lcom/android/server/wm/DexController$PendingActivityInfo;->mWaitingStoppedTasks:Ljava/util/ArrayList;
    ...
    .line 32
    iget-object p0, v0, Lcom/android/server/wm/DexController$PendingActivityInfo;->mOrganizedTaskFragments:Ljava/util/ArrayList;
    ...
    .line 33
    :cond_7
    invoke-virtual {p1, v1}, Lcom/android/server/wm/DexController;->scheduleReparentToDisplayAndStartPendingActivity(Z)V
...
.method public final reparent(Lcom/android/server/wm/Task;ZIZZLjava/lang/String;)V
    ...
    .line 1
    :goto_0
    iget-object v12, v7, Lcom/android/server/wm/TaskFragment;->mTaskSupervisor:Lcom/android/server/wm/ActivityTaskSupervisor;

    .line 2
    iget-object v13, v7, Lcom/android/server/wm/TaskFragment;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;
    ...
    const-string v4, "Can not reparent to same root task, task="

    invoke-direct {v1, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v1, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v4, " already in rootTaskId="
    ...
    .line 13
    :cond_2
    iget-object v6, v12, Lcom/android/server/wm/ActivityTaskSupervisor;->mService:Lcom/android/server/wm/ActivityTaskManagerService;

    if-eqz v4, :cond_4

    iget-boolean v15, v6, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsMultiWindow:Z
    ...
    const-string v3, "Device doesn\'t support multi-window, can not reparent task="

    invoke-direct {v2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v2, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v3, " to root-task="
    ...
    iget-boolean v15, v6, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsMultiDisplay:Z
    ...
    const-string v2, "Device doesn\'t support multi-display, can not reparent task="

    invoke-direct {v1, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v1, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v2, " to rootTaskId="
    ...
    iget-boolean v3, v6, Lcom/android/server/wm/ActivityTaskManagerService;->mSupportsFreeformWindowManagement:Z
    ...
    .line 21
    invoke-virtual {v7, v3, v10}, Lcom/android/server/wm/TaskFragment;->supportsMultiWindowInDisplayArea(Lcom/android/server/wm/TaskDisplayArea;Z)Z
    ...
    const-string v4, "Can not move unresizeable task="

    invoke-direct {v3, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {v3, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v4, " to multi-window root task="

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string v4, " Moving to a fullscreen root task instead."
    ...
    .line 27
    iget-object v5, v2, Lcom/android/server/wm/TaskDisplayArea;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;

    .line 28
    invoke-direct {v4, v5}, Lcom/android/server/wm/Task$Builder;-><init>(Lcom/android/server/wm/ActivityTaskManagerService;)V

    const/4 v5, 0x1

    .line 29
    iput v5, v4, Lcom/android/server/wm/Task$Builder;->mWindowingMode:I

    .line 30
    iput v3, v4, Lcom/android/server/wm/Task$Builder;->mActivityType:I

    .line 31
    iput-object v2, v4, Lcom/android/server/wm/Task$Builder;->mParent:Lcom/android/server/wm/WindowContainer;

    .line 32
    iput-boolean v1, v4, Lcom/android/server/wm/Task$Builder;->mOnTop:Z

    const/4 v6, 0x0

    .line 33
    iput-object v6, v4, Lcom/android/server/wm/Task$Builder;->mActivityOptions:Landroid/app/ActivityOptions;

    .line 34
    invoke-virtual {v4}, Lcom/android/server/wm/Task$Builder;->build()Lcom/android/server/wm/Task;
    ...
    .line 39
    iget-object v1, v7, Lcom/android/server/wm/TaskFragment;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;
    ...
    .line 41
    invoke-virtual {v13}, Lcom/android/server/wm/RootWindowContainer;->getTopDisplayFocusedRootTask()Lcom/android/server/wm/Task;
    ...
    .line 44
    invoke-virtual {v14}, Lcom/android/server/wm/Task;->isTopRootTaskInDisplayArea()Z
    ...
    .line 45
    invoke-virtual {v14, v10}, Lcom/android/server/wm/TaskFragment;->topRunningActivity(Z)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 46
    :cond_12
    invoke-virtual {v7, v11, v15, v9, v10}, Lcom/android/server/wm/Task;->reparent(ILcom/android/server/wm/Task;Ljava/lang/String;Z)V

    .line 47
    invoke-virtual {v12, v7, v14}, Lcom/android/server/wm/ActivityTaskSupervisor;->scheduleUpdatePictureInPictureModeIfNeeded(Lcom/android/server/wm/Task;Lcom/android/server/wm/Task;)V
    ...
    .line 48
    invoke-virtual {v15, v9, v3}, Lcom/android/server/wm/Task;->moveToFront(Ljava/lang/String;Lcom/android/server/wm/Task;)V
    ...
    iget-object v3, v7, Lcom/android/server/wm/TaskFragment;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;
    ...
    .line 50
    iget-object v3, v7, Lcom/android/server/wm/TaskFragment;->mAtmService:Lcom/android/server/wm/ActivityTaskManagerService;

    invoke-virtual {v3, v1, v9}, Lcom/android/server/wm/ActivityTaskManagerService;->setLastResumedActivityUncheckLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)V
    ...
    .line 54
    invoke-virtual {v13}, Lcom/android/server/wm/RootWindowContainer;->resumeFocusedTasksTopActivities()V
    ...
    iget-object v1, v7, Lcom/android/server/wm/TaskFragment;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;
    ...
    .line 58
    invoke-virtual/range {p1 .. p6}, Lcom/android/server/wm/ActivityTaskSupervisor;->handleNonResizableTaskIfNeeded(Lcom/android/server/wm/Task;ILcom/android/server/wm/TaskDisplayArea;Lcom/android/server/wm/Task;Z)V
    ...
    const-string v2, "No support to reparent to PIP, task="
...
.method public final resumeTopActivityInnerLocked(Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;Z)Z
    ...
    .line 60
    .line 61
    sget-object p2, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_STATES_enabled:[Z
...
.method public final reuseOrCreateTask(Landroid/content/pm/ActivityInfo;Landroid/content/Intent;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;ZLcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Landroid/app/ActivityOptions;)Lcom/android/server/wm/Task;
    ...
    .line 10
    .line 11
    iget-boolean v7, v0, Lcom/android/server/wm/TaskFragment;->mCreatedByOrganizer:Z
    ...
    .line 31
    invoke-static {v7, v9}, Lcom/android/server/wm/DisplayContent;->alwaysCreateRootTask(II)Z
    ...
    .line 62
    :cond_2
    iput v9, v0, Lcom/android/server/wm/TaskFragment;->mMinWidth:I

    .line 63
    .line 64
    iput v9, v0, Lcom/android/server/wm/TaskFragment;->mMinHeight:I
    ...
    .line 73
    .line 74
    iget-object v7, v2, Lcom/android/server/wm/TaskChangeNotificationController;->mHandler:Lcom/android/server/wm/TaskChangeNotificationController$MainHandler;
    ...
    .line 77
    .line 78
    invoke-virtual {v7, v10, v3, v8, v4}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    .line 97
    .line 98
    invoke-virtual {v7, v10}, Lcom/android/server/wm/ActivityTaskSupervisor;->getNextTaskIdForUser(I)I
    ...
    .line 104
    .line 105
    iget-object v10, v7, Lcom/android/server/wm/ActivityTaskSupervisor;->mRootWindowContainer:Lcom/android/server/wm/RootWindowContainer;

    .line 106
    .line 107
    iget v10, v10, Lcom/android/server/wm/RootWindowContainer;->mCurrentUser:I
    ...
    .line 122
    .line 123
    iput v7, v10, Lcom/android/server/wm/Task$Builder;->mTaskId:I

    .line 124
    .line 125
    iput-object v1, v10, Lcom/android/server/wm/Task$Builder;->mActivityInfo:Landroid/content/pm/ActivityInfo;

    .line 126
    .line 127
    iput-object v6, v10, Lcom/android/server/wm/Task$Builder;->mActivityOptions:Landroid/app/ActivityOptions;

    .line 128
    .line 129
    iput-object v2, v10, Lcom/android/server/wm/Task$Builder;->mIntent:Landroid/content/Intent;

    .line 130
    .line 131
    iput-object v3, v10, Lcom/android/server/wm/Task$Builder;->mVoiceSession:Landroid/service/voice/IVoiceInteractionSession;

    .line 132
    .line 133
    iput-object v4, v10, Lcom/android/server/wm/Task$Builder;->mVoiceInteractor:Lcom/android/internal/app/IVoiceInteractor;
    ...
    .line 136
    .line 137
    iput-boolean v2, v10, Lcom/android/server/wm/Task$Builder;->mOnTop:Z

    .line 138
    .line 139
    iput-object v0, v10, Lcom/android/server/wm/Task$Builder;->mParent:Lcom/android/server/wm/WindowContainer;

    .line 140
    .line 141
    invoke-virtual {v10}, Lcom/android/server/wm/Task$Builder;->build()Lcom/android/server/wm/Task;
    ...
    .line 155
    iput-object v2, v10, Lcom/android/server/wm/Task;->mDexMetaDataInfo:Lcom/android/server/wm/DexController$DexMetaDataInfo;
    ...
    .line 163
    .line 164
    invoke-virtual {v10, p1, v6, v11}, Lcom/android/server/wm/Task;->updateDexCompatMode(Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;Z)V
    ...
    .line 180
    .line 181
    invoke-virtual {v2, v8}, Lcom/android/server/wm/KeyguardController;->isKeyguardOrAodShowing(I)Z
    ...
    .line 215
    .line 216
    invoke-virtual {v10, v11}, Lcom/android/server/wm/Task;->isResizeable(Z)Z
    ...
    .line 228
    invoke-virtual {v10, v0}, Lcom/android/server/wm/Task;->setBounds(Landroid/graphics/Rect;)I
...
.method public final sendFreeformLogging()V
    ...
    .line 56
    .line 57
    invoke-direct {v7, p0, v5, v1}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda26;-><init>(Lcom/android/server/wm/Task;Ljava/util/ArrayList;[I)V

    .line 58
    .line 59
    .line 60
    invoke-virtual {v6, v7, v0}, Lcom/android/server/wm/DisplayArea;->forAllLeafTasks(Ljava/util/function/Consumer;Z)V
    ...
    .line 66
    .line 67
    iget v0, p0, Lcom/android/server/wm/DexController;->mDisplayFreeformMaxCount:I
    ...
    .line 72
    .line 73
    iput v6, p0, Lcom/android/server/wm/DexController;->mDisplayFreeformMaxCount:I

    .line 74
    .line 75
    const-string p0, "2504"
    ...
    .line 82
    .line 83
    invoke-static {p0, v0, v5}, Lcom/samsung/android/core/CoreSaLogger;->logForDexMW(Ljava/lang/String;Ljava/lang/String;I)V
...
.method public final setIntent(Landroid/content/Intent;Landroid/content/pm/ActivityInfo;)V
    ...
    sget-object v3, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_TASKS_enabled:[Z
    ...
    .line 67
    iget-object v5, p0, Lcom/android/server/wm/Task;->mMaxDimensions:Landroid/graphics/Point;
    ...
    .line 73
    :cond_16
    iget p2, p0, Lcom/android/server/wm/Task;->mUserId:I

    .line 74
    invoke-virtual {p1, p2, p0, v4, v1}, Lcom/android/server/wm/MultiTaskingAppCompatController;->onOverridesChanged(ILcom/android/server/wm/Task;Ljava/lang/String;Z)V
...
.method public final setLockTaskAuth(Lcom/android/server/wm/ActivityRecord;)V
    ...
    .line 10
    .line 11
    sget-object p1, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_LOCKTASK_enabled:[Z
...
.method public final setMinimized(II)V
    ...
    .line 32
    .line 33
    invoke-virtual {v3, p1, p2, p0, v2}, Lcom/android/server/wm/FreeformController;->notifyFreeformMinimizeStateChanged(IILcom/android/server/wm/Task;Z)V
    ...
    .line 63
    .line 64
    invoke-virtual {v2, p0}, Lcom/android/server/wm/TransitionController;->inFinishingTransition(Lcom/android/server/wm/WindowContainer;)Z
...
.method public final setUnMinimizedWhenRestored()V
    ...
    .line 16
    .line 17
    iget-object v0, v0, Lcom/android/server/wm/DexController;->mMinimizedToggleTasks:Ljava/util/List;
...
.method public final setWindowingMode(IZ)V
    ...
    const-string/jumbo v10, "windowingModeChanged"

    invoke-virtual {v3, v10}, Lcom/android/server/wm/DexDockingController;->clearAllTasks(Ljava/lang/String;)V
...
.method public final shouldUpRecreateTaskLocked(Lcom/android/server/wm/ActivityRecord;Ljava/lang/String;)Z
    ...
    .line 56
    .line 57
    new-instance v4, Lcom/android/server/wm/Task$$ExternalSyntheticLambda39;

    .line 58
    .line 59
    invoke-direct {v4, p0, v3}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda39;-><init>(Lcom/android/server/wm/Task;[Z)V
...
.method public final startActivityLocked(Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;ZZLandroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;)V
    ...
    .line 53
    .line 54
    invoke-virtual {v1, v5}, Lcom/android/server/wm/ActivityRecord;->shouldBeVisible(Z)Z
    ...
    .line 83
    .line 84
    iput-boolean v5, v9, Lcom/android/server/wm/ActivityTaskSupervisor;->mUserLeaving:Z
    ...
    .line 122
    const-wide v13, -0x1f6199d2a916c919L    # -2.6085483983225736E157
    ...
    .line 155
    .line 156
    invoke-virtual {v4, v8, v8, v5}, Lcom/android/server/wm/Task;->updateDexCompatMode(Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;Z)V
    ...
    .line 193
    .line 194
    invoke-virtual {v4, v5, v5}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(II)V
    ...
    .line 210
    :cond_d
    invoke-virtual {v4, v6, v5}, Lcom/android/server/wm/DisplayContent;->prepareAppTransition(II)V
    ...
    .line 236
    invoke-static {v3, v4, v1, v8}, Lcom/android/server/wm/Task;->enableEnterPipOnTaskSwitch(Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;)V
    ...
    .line 290
    .line 291
    invoke-virtual {v0, v6, v8}, Lcom/android/server/wm/Task;->ensureActivitiesVisible(ZLcom/android/server/wm/ActivityRecord;)V
...
.method public final supportsMinimizeState()Z
    .locals 3
...
.method public final topRunningNonDelayedActivityLocked(Lcom/android/server/wm/ActivityRecord;)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 4
    invoke-direct {v0, v1}, Lcom/android/server/wm/Task$$ExternalSyntheticLambda29;-><init>(I)V
...
.method public final updateDexCompatMode(Landroid/content/pm/ActivityInfo;Landroid/app/ActivityOptions;Z)V
    .locals 8
    ...
    .line 19
    .line 20
    invoke-virtual {p0, v2, v1}, Lcom/android/server/wm/Task;->getRootActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 45
    :goto_1
    iget v4, p0, Lcom/android/server/wm/Task;->mDexLaunchPolicy:I
    ...
    .line 60
    .line 61
    invoke-virtual {v4, v0, v5}, Lcom/android/server/wm/DexController;->getDexPolicyFlags(Landroid/content/pm/ActivityInfo;Landroid/content/pm/ApplicationInfo;)I
    ...
    .line 79
    .line 80
    const-string v5, "[DexCompat] DexCompatLaunchPolicy: task="
    ...
    .line 87
    .line 88
    const-string v5, " mDexLaunchPolicy=0x"
    ...
    .line 92
    .line 93
    iget v5, p0, Lcom/android/server/wm/Task;->mDexLaunchPolicy:I

    .line 94
    .line 95
    const-string v6, " mResizeMode="
    ...
    .line 144
    .line 145
    iget-object v5, p0, Lcom/android/server/wm/Task;->mDexMetaDataInfo:Lcom/android/server/wm/DexController$DexMetaDataInfo;
    ...
    .line 153
    .line 154
    invoke-virtual {p1, v5, v6}, Lcom/android/server/wm/DexController;->getDexMetadataLaunchSizeLocked(Lcom/android/server/wm/DexController$DexMetaDataInfo;I)Landroid/graphics/Point;
    ...
    .line 247
    .line 248
    iput v1, p0, Lcom/android/server/wm/Task;->mDexCompatUiMode:I
