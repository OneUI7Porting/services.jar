...
.method public final cleanupDisabledPackageTasksLocked(ILjava/lang/String;Ljava/util/Set;)V
    ...
    .line 75
    invoke-virtual/range {v1 .. v8}, Lcom/android/server/wm/ActivityTaskSupervisor;->removeTask(Lcom/android/server/wm/Task;ZZLjava/lang/String;ZII)V
...
.method public final dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    .line 45
    .line 46
    const-string/jumbo v2, "mRecentsComponentForDeX="
    ...
    .line 74
    .line 75
    const-string/jumbo v2, "mFreezeTaskListReorderingPendingTimeout="
    ...
    .line 111
    .line 112
    const-string/jumbo v2, "mHiddenTasks="
...
.method public final notifyTaskRemoved(Lcom/android/server/wm/Task;ZZ)V
    ...
    .line 155
    .line 156
    invoke-virtual {v3, v2, p1}, Lcom/android/server/wm/MultiWindowSupportPolicyController;->updateSupportPolicyLocked(Landroid/content/pm/ActivityInfo;Lcom/android/server/wm/Task;)V
...
.method public final onPackagesSuspendedChanged(IZ[Ljava/lang/String;)V
    ...
    .line 23
    .line 24
    iget-object v1, v10, Lcom/android/server/wm/Task;->realActivity:Landroid/content/ComponentName;
    ...
    .line 37
    .line 38
    iget v1, v10, Lcom/android/server/wm/Task;->mUserId:I
    ...
    .line 41
    .line 42
    iget-boolean v1, v10, Lcom/android/server/wm/Task;->realActivitySuspended:Z
    ...
    .line 45
    .line 46
    iput-boolean p2, v10, Lcom/android/server/wm/Task;->realActivitySuspended:Z
    ...
    .line 66
    :cond_0
    invoke-virtual {p0, v10, v11}, Lcom/android/server/wm/RecentTasks;->notifyTaskPersisterLocked(Lcom/android/server/wm/Task;Z)V
...
.method public final onSystemReadyLocked()V
    ...
    .line 29
    invoke-interface {v2, v6, v3, v4, v7}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;JI)Landroid/content/pm/ApplicationInfo;
    ...
    .line 81
    .line 82
    invoke-interface {v6, v7, v9, v10, v8}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;JI)Landroid/content/pm/ApplicationInfo;
    ...
    .line 89
    .line 90
    iput v6, p0, Lcom/android/server/wm/RecentTasks;->mRecentsUid:I

    .line 91
    .line 92
    iput-object v2, p0, Lcom/android/server/wm/RecentTasks;->mRecentsComponent:Landroid/content/ComponentName;
    :try_end_1
    ...
    .line 96
    .line 97
    const-string v7, "Could not load application info for recents component: "
    ...
    .line 146
    invoke-interface {v2, v6, v3, v4, v0}, Landroid/content/pm/IPackageManager;->getApplicationInfo(Ljava/lang/String;JI)Landroid/content/pm/ApplicationInfo;
    ...
    .line 160
    .line 161
    const-string v2, "Could not load application info for recents componentForDeX: "
...
.method public final trimInactiveRecentTasks()V
    ...
    .line 169
    :cond_a
    iget-boolean v6, v4, Lcom/android/server/wm/Task;->mIsAvoidTrimDexPendingActivityTask:Z
