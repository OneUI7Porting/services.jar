...
.method public final dump(Ljava/io/PrintWriter;Ljava/lang/String;Z)V
    ...
    .line 67
    .line 68
    const-string/jumbo v2, "mLastFocusedRootTask="
...
.method public final getOrCreateRootTask(IIZLcom/android/server/wm/Task;Lcom/android/server/wm/Task;Landroid/app/ActivityOptions;I)Lcom/android/server/wm/Task;
    ...
    .line 2
    :goto_0
    invoke-static {v12, v3}, Lcom/android/server/wm/DisplayContent;->alwaysCreateRootTask(II)Z
    ...
    .line 3
    invoke-virtual {v8, v12, v3}, Lcom/android/server/wm/TaskDisplayArea;->getRootTask(II)Lcom/android/server/wm/Task;
    ...
    .line 5
    iget-object v2, v8, Lcom/android/server/wm/TaskDisplayArea;->mDisplayContent:Lcom/android/server/wm/DisplayContent;
    ...
    .line 6
    invoke-virtual/range {p4 .. p4}, Lcom/android/server/wm/ConfigurationContainer;->isDexMode()Z
    ...
    .line 9
    :cond_3
    invoke-virtual {v10, v8, v9}, Lcom/android/server/wm/Task;->reparent(Lcom/android/server/wm/TaskDisplayArea;Z)V

    .line 10
    invoke-virtual {v10, v3}, Lcom/android/server/wm/Task;->setWindowingMode(I)V

    .line 11
    iput-object v14, v10, Lcom/android/server/wm/Task;->mLastNonFullscreenBounds:Landroid/graphics/Rect;
    ...
    .line 13
    invoke-virtual {v1, v10, v13}, Lcom/android/server/wm/Task;->addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    .line 15
    invoke-virtual {v10, v1, v13}, Lcom/android/server/wm/WindowContainer;->reparent(Lcom/android/server/wm/WindowContainer;I)V
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/android/multiwindow/TaskOrganizerInfo;->setSplitToFreeformTaskId(I)V
    ...
    .line 25
    invoke-virtual {v2, v1}, Lcom/android/server/wm/TaskOrganizerController;->onSplitLayoutChangeRequested(Landroid/os/Bundle;)V
    ...
    .line 28
    invoke-virtual {v8, v10, v13}, Lcom/android/server/wm/TaskDisplayArea;->addChild(Lcom/android/server/wm/WindowContainer;I)V
    ...
    .line 32
    :cond_c
    invoke-static {v11, v14, v10}, Lcom/android/server/wm/ForceLaunchWindowingModeUtils;->resolveForceLaunchWindowingMode(Landroid/app/ActivityOptions;Lcom/android/server/wm/ActivityRecord;Lcom/android/server/wm/Task;)I
    ...
    .line 36
    iget-boolean v4, v1, Lcom/android/server/wm/ActivityTaskSupervisor;->mDeferRootVisibilityUpdate:Z

    if-nez v4, :cond_e

    .line 37
    iput-boolean v2, v1, Lcom/android/server/wm/ActivityTaskSupervisor;->mDeferRootVisibilityUpdate:Z

    .line 38
    :try_start_0
    invoke-virtual {v10, v0}, Lcom/android/server/wm/Task;->setWindowingMode(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 48
    invoke-virtual {v10, v2, v3}, Lcom/android/server/wm/Task;->getRootActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 51
    :cond_10
    invoke-virtual {v10, v2, v2}, Lcom/android/server/wm/TaskFragment;->getTopNonFinishingActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 59
    invoke-virtual/range {p4 .. p4}, Lcom/android/server/wm/ConfigurationContainer;->isDesktopModeEnabled()Z
    ...
    .line 62
    invoke-virtual {v10, v14}, Lcom/android/server/wm/Task;->setBounds(Landroid/graphics/Rect;)I
...
.method public final onRootTaskOrderChanged(Lcom/android/server/wm/Task;)V
    ...
    .line 21
    .line 22
    sget-object v3, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_RECENTS_ANIMATIONS_enabled:[Z
...
.method public final positionChildAt(ILcom/android/server/wm/WindowContainer;Z)V
    ...
    .line 52
    .line 53
    invoke-virtual {p2, v1, v2}, Lcom/android/server/wm/Task;->getRootActivity(ZZ)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 62
    .line 63
    invoke-static {v6, v7}, Lcom/android/server/wm/FreeformController;->useAlwaysOnTopFreeform(ILcom/android/server/wm/DisplayContent;)Z
    ...
    .line 70
    .line 71
    iget-boolean v5, v5, Lcom/android/server/wm/ActivityRecord;->mLaunchedFromBubble:Z
...
.method public final removeChild(Lcom/android/server/wm/WindowContainer;)V
    ...
    .line 71
    .line 72
    iget-object v1, v0, Lcom/android/server/wm/DexController;->mMinimizedToggleTasks:Ljava/util/List;
    ...
    .line 95
    invoke-virtual {v0, v1, v1, p1, v2}, Lcom/android/server/wm/FreeformController;->notifyFreeformMinimizeStateChanged(IILcom/android/server/wm/Task;Z)V
    ...
    .line 107
    .line 108
    iput v1, p1, Lcom/android/server/wm/Task;->mLastMinimizedDisplayType:I

    .line 109
    .line 110
    iput v1, p1, Lcom/android/server/wm/Task;->mLastMinimizedRotation:I
