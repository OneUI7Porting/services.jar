...
.method public final calculateMaxWidth(III)I
    ...
    .line 31
    .line 32
    invoke-direct {p1, v3}, Lcom/android/server/wm/DexDockingController$$ExternalSyntheticLambda1;-><init>(I)V

    .line 33
    .line 34
    .line 35
    invoke-virtual {p0, p1}, Lcom/android/server/wm/WindowContainer;->getTask(Ljava/util/function/Predicate;)Lcom/android/server/wm/Task;
    ...
    .line 43
    :cond_1
    iget p1, p0, Lcom/android/server/wm/TaskFragment;->mMinWidth:I
...
.method public final getDexTaskInfoFlags(Landroid/os/IBinder;)I
    ...
    .line 1
    const-string v0, "getDexTaskInfoFlags: cannot find ActivityRecord, token="

    .line 2
    .line 3
    const-string v1, "getDexTaskInfoFlags"
    ...
    .line 49
    iget p1, v4, Lcom/android/server/wm/Task;->mResizeMode:I

    .line 50
    .line 51
    invoke-static {p1}, Landroid/content/pm/ActivityInfo;->isPreserveOrientationMode(I)Z
    ...
    .line 60
    invoke-virtual {v4, p1}, Lcom/android/server/wm/Task;->isResizeable(Z)Z
    ...
    .line 115
    .line 116
    const-string p1, "Isolated process not allowed to call "
...
.method public final rotateDexCompatTask(Landroid/os/IBinder;)V
    ...
    .line 1
    const-string/jumbo v0, "rotateDexCompatTask: cannot find ActivityRecord, token="

    .line 2
    .line 3
    .line 4
    const-string/jumbo v1, "rotateDexCompatTask: token is not RemoteToken, token="

    .line 5
    .line 6
    .line 7
    const-string/jumbo v2, "rotateDexCompatTask"
    ...
    .line 32
    :try_start_1
    instance-of v2, p1, Lcom/android/server/wm/WindowContainer$RemoteToken;
    ...
    .line 67
    .line 68
    iget-object v1, v1, Lcom/android/server/wm/WindowContainer$RemoteToken;->mWeakRef:Ljava/lang/ref/WeakReference;
    ...
    .line 119
    .line 120
    invoke-virtual {p0, v1}, Lcom/android/server/wm/DexCompatController;->rotateDexCompatTaskLocked(Lcom/android/server/wm/ActivityRecord;)V
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_1
...
.method public final setCandidateTask(I)V
    ...
    .line 55
    .line 56
    iput-object v3, p0, Lcom/android/server/wm/DexDockingController;->mCandidateTask:Ljava/lang/ref/WeakReference;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
...
.method public final toggleFreeformForDexCompatApp(I)V
    ...
    .line 57
    .line 58
    invoke-direct {v3, p1}, Lcom/android/server/wm/DexCompatController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/Task;)V
