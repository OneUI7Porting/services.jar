...
.method public final activityResumed(Landroid/os/IBinder;Z)V
    ...
    .line 55
    .line 56
    invoke-virtual {p0, v4, v3}, Lcom/android/server/wm/PersonaActivityHelper;->notifyActivityResumedLocked(ZLcom/android/server/wm/ActivityRecord;)V
    ...
    .line 65
    .line 66
    invoke-virtual {v3, p0}, Lcom/android/server/wm/ActivityRecord;->isState(Lcom/android/server/wm/ActivityRecord$State;)Z
    ...
    .line 71
    .line 72
    iget-boolean p0, v3, Lcom/android/server/wm/ActivityRecord;->noDisplay:Z
    ...
    .line 75
    .line 76
    iget-object p0, v3, Lcom/android/server/wm/ActivityRecord;->shortComponentName:Ljava/lang/String;

    .line 77
    .line 78
    invoke-static {p0}, Lcom/android/server/DualAppManagerService;->notifyActivityResumedLocked(Ljava/lang/String;)V
...
.method public final activityStopped(Landroid/os/IBinder;Landroid/os/Bundle;Landroid/os/PersistableBundle;Ljava/lang/CharSequence;)V
    ...
    .line 110
    .line 111
    iget-object p3, p2, Lcom/android/server/wm/DexController;->mGlobalLock:Lcom/android/server/wm/WindowManagerGlobalLock;
    ...
    .line 117
    :try_start_1
    iget-object p4, p2, Lcom/android/server/wm/DexController;->mPendingActivityInfo:Lcom/android/server/wm/DexController$PendingActivityInfo;

    .line 118
    .line 119
    iget-object p4, p4, Lcom/android/server/wm/DexController$PendingActivityInfo;->mWaitingStoppedTasks:Ljava/util/ArrayList;
    ...
    .line 126
    .line 127
    iget-object p4, p1, Lcom/android/server/wm/ActivityRecord;->task:Lcom/android/server/wm/Task;
    ...
    .line 130
    .line 131
    new-instance v2, Lcom/android/server/wm/DexController$$ExternalSyntheticLambda8;
    ...
    .line 135
    .line 136
    invoke-virtual {p4, v2}, Lcom/android/server/wm/WindowContainer;->getActivity(Ljava/util/function/Predicate;)Lcom/android/server/wm/ActivityRecord;
    ...
    .line 141
    .line 142
    iget-object v2, p2, Lcom/android/server/wm/DexController;->mPendingActivityInfo:Lcom/android/server/wm/DexController$PendingActivityInfo;
    ...
    .line 145
    .line 146
    invoke-virtual {v2, v4, p4}, Lcom/android/server/wm/DexController$PendingActivityInfo;->removeWaitingStoppedTask(Ljava/lang/String;Lcom/android/server/wm/Task;)Z
    ...
    .line 163
    .line 164
    iget-object p4, p4, Lcom/android/server/wm/DexController$PendingActivityInfo;->mWaitingTransitionFinishedTokens:Ljava/util/ArrayList;
    ...
    .line 171
    .line 172
    const-string p4, "DexController"

    .line 173
    .line 174
    const-string/jumbo v2, "reparentToDisplayAndStartPendingActivity from activityStopped"
    ...
    .line 181
    invoke-virtual {p2, p4}, Lcom/android/server/wm/DexController;->scheduleReparentToDisplayAndStartPendingActivity(Z)V
...
.method public final finishActivity(Landroid/os/IBinder;ILandroid/content/Intent;I)Z
    ...
    .line 267
    :try_start_9
    invoke-virtual/range {v8 .. v15}, Lcom/android/server/wm/ActivityTaskSupervisor;->removeTask(Lcom/android/server/wm/Task;ZZLjava/lang/String;ZII)V
...
.method public final setImmersive(Landroid/os/IBinder;Z)V
    ...
    .line 28
    .line 29
    sget-object p2, Lcom/android/internal/protolog/ProtoLogImpl_54989576$Cache;->WM_DEBUG_IMMERSIVE_enabled:[Z
    ...
    .line 69
    .line 70
    invoke-direct {v2, p0, p2, p1}, Lcom/android/server/wm/ActivityTaskManagerService$$ExternalSyntheticLambda16;-><init>(Lcom/android/server/wm/ActivityTaskManagerService;ZLcom/android/server/wm/ActivityRecord;)V
...
.method public final toggleFreeformWindowingMode(Landroid/os/IBinder;)V
    ...
    .line 64
    .line 65
    new-instance v0, Lcom/android/server/wm/DexCompatController$$ExternalSyntheticLambda0;

    .line 66
    .line 67
    invoke-direct {v0, p1}, Lcom/android/server/wm/DexCompatController$$ExternalSyntheticLambda0;-><init>(Lcom/android/server/wm/Task;)V
    ...
    .line 81
    .line 82
    invoke-virtual {p0, p1, v0, v4, v5}, Lcom/android/server/wm/DexCompatController;->scheduleStartActivityAsToggleFreeform(Lcom/android/server/wm/Task;Ljava/util/function/BooleanSupplier;Ljava/util/function/IntSupplier;Ljava/util/function/Supplier;)V
    ...
    .line 111
    .line 112
    iget-object p1, v4, Lcom/android/server/wm/ActivityRecord;->task:Lcom/android/server/wm/Task;

    .line 113
    .line 114
    iput-object p0, p1, Lcom/android/server/wm/Task;->mLastNonFullscreenBounds:Landroid/graphics/Rect;
    ...
    .line 118
    :cond_3
    invoke-virtual {v4}, Lcom/android/server/wm/ActivityRecord;->supportsFreeform()Z
    ...
    .line 140
    :cond_4
    invoke-virtual {p1, v5}, Lcom/android/server/wm/Task;->isResizeable(Z)Z
    ...
    .line 191
    .line 192
    invoke-virtual {v7}, Lcom/android/server/wm/ConfigurationContainer;->isDesktopModeEnabled()Z
    ...
    .line 197
    .line 198
    iget-object p1, v7, Lcom/android/server/wm/Task;->mLastNonFullscreenBounds:Landroid/graphics/Rect;
    ...
    .line 208
    :cond_7
    iput-boolean v5, v7, Lcom/android/server/wm/Task;->mTakeInitBounds:Z
    ...
    .line 211
    .line 212
    iget-object v6, p1, Lcom/android/server/wm/ActivityTaskSupervisor;->mLaunchParamsController:Lcom/android/server/wm/LaunchParamsController;
    ...
    .line 215
    .line 216
    iget-object v8, p1, Landroid/content/pm/ActivityInfo;->windowLayout:Landroid/content/pm/ActivityInfo$WindowLayout;
