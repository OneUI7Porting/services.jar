...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/wm/WindowManagerService;)V
    ...
    .line 58
    new-instance v5, Lcom/android/server/smartclip/SmartClipRemoteRequestSyncManager;

    invoke-direct {v5}, Lcom/android/server/smartclip/SmartClipRemoteRequestSyncManager;-><init>()V

    iput-object v5, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mSmartClipRemoteRequestSyncManager:Lcom/android/server/smartclip/SmartClipRemoteRequestSyncManager;
    ...
    .line 61
    new-instance v7, Lcom/android/server/smartclip/SpenGestureManagerService$1;

    invoke-direct {v7, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$1;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    .line 62
    new-instance v3, Lcom/android/server/smartclip/SpenGestureManagerService$4;

    invoke-direct {v3, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$4;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    iput-object v3, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mPenDoubleTap:Lcom/android/server/smartclip/SpenGestureManagerService$4;

    .line 63
    new-instance v3, Lcom/android/server/smartclip/SpenGestureManagerService$5;

    invoke-direct {v3, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$5;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    iput-object v3, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mHandler:Lcom/android/server/smartclip/SpenGestureManagerService$5;

    .line 64
    new-instance v4, Lcom/android/server/smartclip/SpenGestureManagerService$6;

    invoke-direct {v4, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$6;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    iput-object v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mAcServiceConnection:Lcom/android/server/smartclip/SpenGestureManagerService$6;

    const/16 v4, 0xa

    .line 65
    iput v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->ALLOWANCE_RANGE_X:I

    .line 66
    iput v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->ALLOWANCE_RANGE_Y:I

    const/16 v5, 0x12c

    .line 67
    iput v5, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->ALLOWANCE_HOVER_TIME:I
    ...
    iput-object v5, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mPenDataStructArray:Ljava/util/List;

    .line 69
    sput-object p1, Lcom/android/server/smartclip/SpenGestureManagerService;->mContext:Landroid/content/Context;

    .line 70
    const-string v5, "SpenGestureManagerService"

    const-string v6, "SpenGestureManagerService(Context context, WindowManagerService Wm)"
    ...
    const-string v8, "SEC_FLOATING_FEATURE_FRAMEWORK_CONFIG_SPEN_VERSION"

    invoke-virtual {v6, v8}, Lcom/samsung/android/feature/SemFloatingFeature;->getInt(Ljava/lang/String;)I

    move-result v6

    iput v6, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mSpenUspLevel:I
    ...
    .line 73
    iput-boolean v2, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mInboxSPen:Z
    ...
    new-instance v8, Lcom/android/server/smartclip/SpenGestureManagerService$2;

    invoke-direct {v8, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$2;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    invoke-direct {v4, v6, v8}, Landroid/view/GestureDetector;-><init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;)V

    iput-object v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mGestureDetector:Landroid/view/GestureDetector;

    .line 77
    new-instance v4, Lcom/android/server/smartclip/SpenGestureManagerService$3;

    .line 78
    invoke-direct {v4}, Lcom/android/internal/content/PackageMonitor;-><init>()V
    ...
    invoke-virtual {v4, v6, v8, v9, v2}, Lcom/android/internal/content/PackageMonitor;->register(Landroid/content/Context;Landroid/os/Looper;Landroid/os/UserHandle;Z)V
    ...
    .line 82
    new-instance v4, Lcom/android/server/smartclip/SpenGestureManagerService$SPenGestureInputEventReceiver;

    invoke-direct {v4, p0}, Lcom/android/server/smartclip/SpenGestureManagerService$SPenGestureInputEventReceiver;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;)V

    .line 83
    invoke-virtual {p2, v4, v1}, Lcom/android/server/wm/WindowManagerService;->registerPointerEventListener(Landroid/view/WindowManagerPolicyConstants$PointerEventListener;I)V
    ...
    invoke-static {p1, v4, v1, v12}, Landroid/provider/Settings$Secure;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    const-string v4, "checkSettingCondition, LOCK_SCREEN_QUICK_NOTE : "

    invoke-direct {p1, v4}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-boolean v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mIsEnableLockScreenQuickNote:Z
    ...
    .line 94
    iget-boolean v4, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mInboxSPen:Z

    if-eqz v4, :cond_3

    .line 95
    const-string v4, "com.sec.android.intent.action.BLACK_MEMO"

    invoke-virtual {p1, v4}, Landroid/content/IntentFilter;->addAction(Ljava/lang/String;)V

    .line 96
    :cond_3
    invoke-virtual {p2}, Lcom/android/server/smartclip/BleSpenManager;->isSupportBleSpen()Z
    ...
    invoke-direct {p1, p0, v3}, Lcom/android/server/smartclip/SpenGestureManagerService$AcSettingsObserver;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService;Lcom/android/server/smartclip/SpenGestureManagerService$5;)V
    ...
    const-string v6, "air_cmd_use_minimized"

    invoke-static {v4, v6, v1, v12}, Landroid/provider/Settings$System;->semGetIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    .line 105
    invoke-virtual {p2, v2, v1, p1, v0}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V
    ...
    .line 107
    invoke-virtual {p2, v2, v1, p1}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;)V
    ...
    invoke-direct {v4, p1, v3}, Lcom/android/server/smartclip/SpenGestureManagerService$AcSettingsObserver$1;-><init>(Lcom/android/server/smartclip/SpenGestureManagerService$AcSettingsObserver;Lcom/android/server/smartclip/SpenGestureManagerService$5;)V

    .line 110
    invoke-virtual {p2, v2, v1, v4, v0}, Landroid/content/ContentResolver;->registerContentObserver(Landroid/net/Uri;ZLandroid/database/ContentObserver;I)V

    .line 111
    iget p1, p0, Lcom/android/server/smartclip/SpenGestureManagerService;->mSpenUspLevel:I
    ...
    .line 113
    :cond_6
    const-string p0, "Theme isn\'t supported. Not a spen model."
