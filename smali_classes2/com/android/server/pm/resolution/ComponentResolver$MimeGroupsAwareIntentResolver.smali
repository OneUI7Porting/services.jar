...
.method public final addFilter(Lcom/android/server/pm/snapshot/PackageDataSnapshot;Landroid/util/Pair;)V
    ...
    .line 5
    invoke-virtual {v2}, Landroid/content/IntentFilter;->countMimeGroups()I
    ...
    .line 7
    invoke-interface {v4}, Lcom/android/internal/pm/pkg/component/ParsedComponent;->getPackageName()Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v4}, Lcom/android/server/pm/PackageSetting;->getMimeGroups()Ljava/util/Map;

    move-result-object v4

    .line 10
    invoke-virtual {v2, v3}, Landroid/content/IntentFilter;->getMimeGroup(I)Ljava/lang/String;
    ...
    .line 12
    :try_start_0
    invoke-virtual {v2, v5}, Landroid/content/IntentFilter;->addDynamicDataType(Ljava/lang/String;)V
    :try_end_0
...
.method public final bridge synthetic addFilter(Lcom/android/server/pm/snapshot/PackageDataSnapshot;Ljava/lang/Object;)V
    .locals 0
