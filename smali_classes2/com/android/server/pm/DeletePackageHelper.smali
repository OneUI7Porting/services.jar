...
.method public final deletePackageLIF(Ljava/lang/String;Landroid/os/UserHandle;Z[IILcom/android/server/pm/PackageRemovedInfo;Z)Z
    ...
    .line 3
    const-string v2, "Attempt to delete keyguard system package "
    ...
    .line 17
    :try_start_0
    const-string/jumbo v8, "persist.sys.knox.non_required_apps_task"
    ...
    :cond_0
    :try_start_1
    iget-object v8, v1, Lcom/android/server/pm/DeletePackageHelper;->mDpms:Landroid/app/admin/IDevicePolicyManager;
    ...
    .line 53
    iput-object v8, v1, Lcom/android/server/pm/DeletePackageHelper;->mDpms:Landroid/app/admin/IDevicePolicyManager;
    ...
    .line 64
    .line 65
    invoke-direct {v9, v0, v0}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 69
    .line 70
    invoke-interface {v8, v9, v7, v0}, Landroid/app/admin/IDevicePolicyManager;->getDisallowedSystemApps(Landroid/content/ComponentName;ILjava/lang/String;)Ljava/util/List;
    ...
    .line 98
    .line 99
    invoke-virtual {v5, p1}, Lcom/android/server/pm/Settings;->getPackageLPr(Ljava/lang/String;)Lcom/android/server/pm/PackageSetting;
    ...
    .line 121
    .line 122
    invoke-interface {v6, v9}, Lcom/android/server/pm/PackageManagerServiceInjector$ServiceProducer;->produce(Ljava/lang/Class;)Ljava/lang/Object;
    ...
    .line 153
    .line 154
    invoke-virtual {v9, v10}, Lcom/android/server/pm/Settings;->getDisabledSystemPkgLPr(Ljava/lang/String;)Lcom/android/server/pm/PackageSetting;
    ...
    .line 174
    .line 175
    invoke-virtual {v0, v6, p1, v7}, Lcom/android/server/pm/PackageManagerService;->checkPermission(Ljava/lang/String;Ljava/lang/String;I)I
    ...
    .line 204
    .line 205
    invoke-static {v6, p2, v10, v5, v9}, Lcom/android/server/pm/DeletePackageHelper;->mayDeletePackageLocked(ILandroid/os/UserHandle;Lcom/android/server/pm/PackageRemovedInfo;Lcom/android/server/pm/PackageSetting;Lcom/android/server/pm/PackageSetting;)Lcom/android/server/pm/DeletePackageAction;
...
.method public final deletePackageX(IIJLjava/lang/String;Z)I
    ...
    .line 787
    .line 788
    invoke-virtual/range {v32 .. v37}, Lcom/android/server/pm/BroadcastHelper;->sendResourcesChangedBroadcastAndNotify(Lcom/android/server/pm/Computer;ZZLjava/util/ArrayList;Lcom/android/server/pm/AsecInstallHelper$3;)V
    ...
    .line 1352
    .line 1353
    invoke-static {v0, v4, v3}, Lcom/android/server/am/ActivityManagerService$$ExternalSyntheticOutline0;->m(Landroid/os/RemoteException;Ljava/lang/StringBuilder;Ljava/lang/String;)V
