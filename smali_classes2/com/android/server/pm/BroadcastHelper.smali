...
.method public final notifyResourcesChanged(ZZ[Ljava/lang/String;[I)V
    ...
    .line 44
    invoke-virtual/range {v0 .. v8}, Lcom/android/server/pm/PackageMonitorCallbackHelper;->notifyPackageMonitor(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;[I[ILandroid/util/SparseArray;Landroid/os/Handler;Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;)V
...
.method public final sendDistractingPackagesChanged(Lcom/android/server/pm/Computer;[Ljava/lang/String;[III)V
    .locals 2
    ...
    .line 20
    .line 21
    new-instance p2, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda7;

    .line 22
    .line 23
    invoke-direct {p2, p0, v0, p4, p1}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda7;-><init>(Lcom/android/server/pm/BroadcastHelper;Landroid/os/Bundle;ILcom/android/server/pm/Computer;)V
...
.method public final sendPackagesSuspendedOrUnsuspendedForUser(Lcom/android/server/pm/Computer;Ljava/lang/String;[Ljava/lang/String;[IZI)V
    .locals 9
    ...
    .line 39
    new-instance v8, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;
    ...
    .line 42
    invoke-direct {v8, p1, p3}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/pm/Computer;I)V

    .line 43
    .line 44
    .line 45
    new-instance p1, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda9;
    ...
    .line 53
    invoke-direct/range {v0 .. v6}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda9;-><init>(Lcom/android/server/pm/BroadcastHelper;Ljava/lang/String;Landroid/os/Bundle;ILcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;Landroid/os/Bundle;)V
...
.method public final sendResourcesChangedBroadcast(Lcom/android/server/pm/Computer;ZZ[Ljava/lang/String;[ILcom/android/server/pm/AsecInstallHelper$3;)V
    .locals 14
    ...
    .line 51
    :goto_1
    new-instance v12, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;
    ...
    .line 55
    invoke-direct {v12, p1, v0}, Lcom/android/server/pm/BroadcastHelper$$ExternalSyntheticLambda6;-><init>(Lcom/android/server/pm/Computer;I)V
...
.method public final sendResourcesChangedBroadcastAndNotify(Lcom/android/server/pm/Computer;ZZLjava/util/ArrayList;Lcom/android/server/pm/AsecInstallHelper$3;)V
    .locals 10
    ...
    .line 40
    invoke-virtual/range {v1 .. v7}, Lcom/android/server/pm/BroadcastHelper;->sendResourcesChangedBroadcast(Lcom/android/server/pm/Computer;ZZ[Ljava/lang/String;[ILcom/android/server/pm/AsecInstallHelper$3;)V
...
.method public final sendSessionCommitBroadcast(Lcom/android/server/pm/Computer;Landroid/content/pm/PackageInstaller$SessionInfo;ILjava/lang/String;)V
    ...
    .line 55
    .line 56
    iget-object v5, p0, Lcom/android/server/pm/BroadcastHelper;->mUmInternal:Lcom/android/server/pm/UserManagerService$LocalService;

    .line 57
    .line 58
    invoke-virtual {v5, p3}, Lcom/android/server/pm/UserManagerService$LocalService;->getUserProperties(I)Landroid/content/pm/UserProperties;
    ...
    .line 62
    invoke-virtual {v5}, Landroid/content/pm/UserProperties;->getProfileApiVisibility()I
    ...
    .line 79
    const-string v7, "android.permission.ACCESS_HIDDEN_PROFILES_FULL"
    ...
    .line 131
    iget-object v6, p0, Lcom/android/server/pm/BroadcastHelper;->mContext:Landroid/content/Context;
    ...
    .line 169
    invoke-virtual {v5, p4, v0}, Landroid/content/Context;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
    ...
    .line 199
    .line 200
    invoke-virtual {p1}, Lcom/samsung/android/desktopmode/DesktopModeManagerInternal;->isDesktopModeEnablingOrEnabled()Z
